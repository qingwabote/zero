...
import { UIBoundsEventType, UIElement, UIEventToListener } from "./UIElement.js";
...
export class UIContainer<EventToListener extends UIEventToListener = UIEventToListener> extends UIElement<EventToListener> {
