...
export class UIDocument extends Component {
    ...
    constructor(node: Node) {
        ...
        Zero.instance.input.on(InputEvent.TOUCH_MOVE, event => this.touchHandler(event.touches[0], UITouchEventType.TOUCH_MOVE));
        Zero.instance.input.on(InputEvent.TOUCH_END, event => this.touchHandler(event.touches[0], UITouchEventType.TOUCH_END));
    }
