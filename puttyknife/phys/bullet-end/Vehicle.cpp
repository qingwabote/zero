...
int physVehicle_addWheel(phys::Vehicle *vehicle, const phys::Vector3 *connectionPointCS0, const phys::Vector3 *wheelDirectionCS0, const phys::Vector3 *wheelAxleCS, float suspensionRestLength, float suspensionStiffness, float wheelRadius, bool isFrontWheel)
{
...
void physVehicle_updateWheelTransform(phys::Vehicle *vehicle, int wheelIndex)
{
    vehicle->updateWheelTransform(wheelIndex, false);
}
