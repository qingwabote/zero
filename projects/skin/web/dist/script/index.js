...
import { Camera, DirectionalLight, GLTF, Node, Pipeline, SkinnedAnimation, Zero, bundle as builtin, device, mat3, vec3 } from "engine";
...
const [model, primitive, pipeline] = await Promise.all([
    await (await bundle.once('walkrun_and_idle/scene', GLTF)).instantiate(macros, function (params) {
