...
import { AttachmentDescription, ClearFlagBits, ImageLayout, LOAD_OP, RenderPassInfo, TextureUsageFlagBits } from "gfx";
const framebuffer2clearFlags2renderPass = new Map;
export function getRenderPass(framebuffer, clears = ClearFlagBits.NONE) {
