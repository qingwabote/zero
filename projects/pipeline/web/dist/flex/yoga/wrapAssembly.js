 ...
 */
// @ts-nocheck
import YGEnums, { Direction, Unit } from './generated/YGEnums.js';
...
export default function wrapAssembly(lib) {
    ...
    patch(lib.Node.prototype, 'calculateLayout', function (original, width = NaN, height = NaN, direction = Direction.LTR) {
        // Just a small patch to add support for the function default parameters
        return original.call(this, width, height, direction);
    });
    return Object.assign({ Config: lib.Config, Node: lib.Node }, YGEnums);
}
