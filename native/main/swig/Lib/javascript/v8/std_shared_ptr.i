...
%typemap(in, noblock=1) std::shared_ptr< TYPE > (std::shared_ptr<TYPE> *temp = 0 ,int res = 0) {
...
%typemap(in, noblock=1) std::shared_ptr< TYPE > & = std::shared_ptr< TYPE > *;
...
%typemap (out) std::shared_ptr< TYPE > & = std::shared_ptr< TYPE > *;
