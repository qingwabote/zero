...
namespace bg
{
    ...
    public:
        ...
        zero::WebSocketCallback onclose() { throw "not implemented yet"; }
        void onclose(zero::WebSocketCallback &callback) { onclose(std::move(callback)); }
        virtual void onclose(zero::WebSocketCallback &&callback) override;
